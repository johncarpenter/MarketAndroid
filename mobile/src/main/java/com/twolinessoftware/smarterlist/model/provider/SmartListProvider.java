...
public class SmartListProvider extends MappedContentProvider<SmartList>{

        public static final String PROVIDER_NAME = "com.twolinessoftware.smarterlist.smartlist";

        public static final Uri CONTENT_URI = Uri.parse("content://" + PROVIDER_NAME);

        public static final String RETURN_TYPE ="vnd.android.cursor.dir/vnd.twolinessoftware.smarterlist.smartlist";
